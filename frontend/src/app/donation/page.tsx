        ...
        <section className="py-16 max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              <div key={t.label} className={`card p-6 text-center ${t.featured ? 'border-gold-400 border-2' : ''}`}>
          ...
          <div className="card p-8 text-center">
            ...
            <div className="flex max-w-sm mx-auto gap-3">
              <input type="number" className="input flex-1" placeholder="Enter amount (BDT)" min="100" />
