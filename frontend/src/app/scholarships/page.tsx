...
const scholarships = [
  ...
  { name: 'Research Fellowship', amount: '25,000 BDT', criteria: 'Students with published research papers', deadline: 'August 1, 2026' },
];
      ...
      <main className="flex-1">
        ...
        <section className="py-16 max-w-5xl mx-auto px-4">
          <div className="grid gap-6">
            {scholarships.map((s) => (
              <div key={s.name} className="card p-6 flex items-start justify-between gap-4">
          ...
          <div className="mt-10 text-center p-8 bg-gray-50 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-500 text-sm mb-4">Help fund scholarships for future CSEDU students through club contributions.</p>
